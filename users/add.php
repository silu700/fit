...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    // ... tutaj zostaje Twoja logika zapisu (INSERT) ...
    $imie = $_POST['imie'];
...
<div class="container-fluid d-flex justify-content-center align-items-center" style="min-height: 85vh; padding: 20px 0;">
