  ...
  <table class="table table-hover align-middle mb-0" id="exercisesTable">
    <thead class="table-light">
        <tr>
            ...
            <th style="width: 20%;">Główne partie mięśniowe</th>
            <th>Linki</th>
            <th>Miniatura</th>
        ...
        <tr class="exercise-row">
            ...
            <td>
                <?php 
                    ...
                    arsort($activeMuscles); // Sortowanie od najsilniej angażowanych
                    $topMuscles = array_slice($activeMuscles, 0, 3, true); // Tylko 3 pierwsze
                    
                    foreach ($topMuscles as $label => $val): ?>
                        <span class="d-block small mb-1">
                            <i class="fas fa-caret-right text-primary me-1"></i> <?= $label ?>
                        </span>
                <?php endforeach; ?>
            </td>
            <td>
            ...
            <td>
                ...
                ?>
                <?php if ($imgUrl): ?>
                    <img src="<?= $imgUrl ?>" style="width: 150px; height: 103px; object-fit: cover; border-radius: 5px;" alt="foto">
                <?php else: ?>
                    <div class="bg-light border rounded text-muted d-flex align-items-center justify-content-center" style="width: 150px; height: 103px;">
