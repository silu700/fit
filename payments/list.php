        ...
        <div class="card-body">
            <div class="row align-items-center">
                ...
                <div class="col-md-3 text-center border-start">
                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Zebrano łącznie</div>
                        ...
                        <tr class="<?= !$l['payment_id'] ? 'table-light' : '' ?>">
                            ...
                            <td class="text-center">
                                <?php if($l['payment_id']): ?>
                                    ...
                                    <a href="delete.php?id=<?= $l['payment_id'] ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Usunąć wpłatę?')"><i class="fas fa-trash"></i></a>
                                <?php else: ?>
